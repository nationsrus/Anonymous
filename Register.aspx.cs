...
namespace Anonymous
{
    public partial class Register : System.Web.UI.Page
    {
        ...
        private void registration()
        {
            ...
            bool recaptchaSuccess = false;

            //if (Request.Params["g-recaptcha-response"] != null)
            //{
            //    Response.Write("g-recaptcha-response1: " + Request.Params["g-recaptcha-response"].ToString());
            //}

            //if (HttpContext.Current.Request.Form["g-recaptcha-response"]!=null)
            //{
            //    Response.Write("g-recaptcha-response2: " + HttpContext.Current.Request.Form["g-recaptcha-response"].ToString());
            //}
            ...
            //Response.Write(@" ...recaptcha response done... ");
            //Response.End();
            ...
            if (recaptchaSuccess)
            {
                ...
                {
                    lblRegistrationError.Text = @"Email already exists in our system. Go to <a href='login'>Login</a> by <a href='login'>clicking here.</a>";
            ...
            {
                lblRegistrationError.Text = "Recaptcha failure. Please stop acting like a robot :P";
                lblRegistrationError.Visible = true;
            }
